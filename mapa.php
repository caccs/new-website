  ...
  <div id="content">
    ...
    <div id="main-content">
      ...
      <map name ="mapa">
        ...
        <area shape = "poly" coords = "352,248,422,233,429,266,360,282" onMouseOver = "toolTip('Edificio Aulas Teoricas e Laboratorios (ATLab)', 210, 100)" onMouseOut = "toolTip()" href="atlab.php">
      </map>

      <img src="images\mapaUfscar3.jpg" usemap = "#mapa">
    </div>
  </div>
</body>
</html>